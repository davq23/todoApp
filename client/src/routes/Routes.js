        ...
        <Switch>
          <Route exact path={`${process.env.REACT_APP_ROUTE_PREFIX}/`}>
            {currentUser ? (
              ...
              <Redirect to={`${process.env.REACT_APP_ROUTE_PREFIX}/login`} />
            )}
          </Route>
          <Route exact path={`${process.env.REACT_APP_ROUTE_PREFIX}/statistics`}>
            {currentUser ? (
              <Statistics />
            ) : (
              <Redirect to={`${process.env.REACT_APP_ROUTE_PREFIX}/login`} />
          ...
          <Route exact path={`${process.env.REACT_APP_ROUTE_PREFIX}/login`}>
            {currentUser ? (
              <Redirect to={`${process.env.REACT_APP_ROUTE_PREFIX}/`} />
            ) : (
              <Login className="FormBox" />
            )}
          </Route>
